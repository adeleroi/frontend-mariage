        ...
        <div className="w-full lg:mt-24 flex lg:items-start items-center lg:justify-between lg:flex-row  flex-col">
          <div className="flex flex-col mt-16 lg:mt-0 2xl:flex-row xl:justify-between">
            <div>
              ...
              <Paragraph className='text-left text-lg xl:text-xl 2xl:mb-0 font-thin leading-10 2xl:mr-12'>
              Nous n'avons pas de liste de cadeaux prédéfinie. Si vous n’avez pas d’idées de cadeaux (parce qu’après tout, c’est quand même pas si facile d’en trouver 😅😅), ou que vous craignez qu’une ou plusieurs personnes offrent la même chose que vous, ne vous en faites pas plus : nous prendrons vos dons en espèces ☺️.
              </Paragraph>
            </div>
          </div>
        </div>
